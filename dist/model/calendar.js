...
export function generateCalendarBody(date, events) {
    ...
    if (numDernierJourDuMois == 0)
        numDernierJourDuMois = 7;
...
function ajouteCaseActive(numéroJour, events) {
...
export function calendarHeaderComponent(date) {
...
export function changeCalendarDate(date) {
